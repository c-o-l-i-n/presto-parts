...
import { emptyRenderBaseElement, mockAppData, mockChangeValue, mockElectronApi } from './mocks'
...
describe('SeparatePage', () => {
  ...
  it('should have "Choose PDF" button', () => {
    const chooseFileButton = screen.queryByText('Choose File', { selector: 'button' })
  ...
  describe('after choosing a file with the "Choose File" button', () => {
    ...
    beforeEach(async () => {
      ...
      chooseFileButton = screen.getByText('Choose File', { selector: 'button' })
